...
ALL_CLASSES = [
    ...
    'kohomba_soup', 'larich_chilli_powder', 'lemon_puff', 'link_paspanguwa',
    'lipton_yellow_label', 'maggi_noodles',
...
CLASS_PROMPTS = {
    ...
    'kohomba_soup':              'kohomba herbal soap bar',
    'larich_chilli_powder':      'larich chilli powder packet',
    'lemon_puff':                'lemon puff biscuit packet',
    'link_paspanguwa':           'link paspanguwa herbal tablet pack',
